...
# This script exports the env variable MASSCALCULATOR_GUI_SOURCE, pointing at the 
...
MASSCALCULATOR_GUI_SOURCE="$(dirname "$(dirname "$(realpath "${BASH_SOURCE}")")")" > /dev/null
export MASSCALCULATOR_GUI_SOURCE
